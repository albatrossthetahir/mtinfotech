    ...
    <section className="w-full mt-6 container mx-auto relative z-10">
      <div className="grid lg:grid-cols-2 gap-3 sm:gap-5 lg:gap-6">
        ...
        <div className="text-center shadow-[inset_0_1px_0_1px_rgba(255,255,255,0.06)] bg-[#1b1b1b] rounded-xl px-4 py-14 sm:py-20 md:py-24 lg:py-32">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-white opacity-40 max-w-[444px] mx-auto mt-5 mb-7">As a web developer, I am proficient in a variety of programming languages and frameworks, including HTML, CSS, JavaScript, React, NextJs.</p>
          <CallFreeBtn/>
        </div>
      </div>
    </section>
