...
export default function Headings({title, subTitle, titleClassName, subTitleClassName, innerTitle}) {
  return (
    <div className="text-center">
        ...
        {title && <h3 className={cn("mt-3 text-white text-2xl lg:text-4xl xl:text-5xl 2xl:text-[64px] !leading-tight text-center font-medium tracking-tight", titleClassName)}>{title} <span className="text-white/40 inline-block">{innerTitle}</span></h3>}
    </div>
  );
}
